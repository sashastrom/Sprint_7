...
@allure.story("Тестирование с помощью параметризации")
@allure.description("Проверяем что: можно указать разные параметры цветов, тело ответа содержит track")
def test_create_order(first_name, last_name, address, metro_station, phone, rent_time, delivery_date, comment, color,
